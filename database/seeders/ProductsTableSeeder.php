    ...
    public function run()
    {
      ...
      for ($i=1; $i <= 30; $i++) {
          Product::create([
              ...
              'image' => 'products\December2021\laptop-'.$i,
      ...
      for ($i = 1; $i <= 9; $i++) {
          Product::create([
              ...
              'image' => 'products\December2021\desktop-'.$i,
              'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
          ])->categories()->attach(2);
      }
      ...
      for ($i = 1; $i <= 9; $i++) {
          Product::create([
              ...
              'image' => 'products\December2021\phone-'.$i,
              'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
          ])->categories()->attach(3);
      }
      ...
      for ($i = 1; $i <= 9; $i++) {
          Product::create([
              ...
              'image' => 'products\December2021\tablet-'.$i,
              'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
          ])->categories()->attach(4);
      }
      ...
      for ($i = 1; $i <= 9; $i++) {
          Product::create([
              ...
              'price' => rand(79999, 149999),
              'image' => 'products\December2021\tv-'.$i,
              'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
          ])->categories()->attach(5);
      }
      ...
      for ($i = 1; $i <= 9; $i++) {
          Product::create([
              ...
              'image' => 'products\December2021\camera-'.$i,
              'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
          ])->categories()->attach(6);
      }
      ...
      for ($i = 1; $i <= 9; $i++) {
          Product::create([
              ...
              'price' => rand(79999, 149999),
              'image' => 'products\December2021\appliance-'.$i,
              'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
          ])->categories()->attach(7);
      }
    }
